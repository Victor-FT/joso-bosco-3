...
export const Project: React.FC<ProjectProps> = ({ url, nome, foto, tipo }) => {
  const [isHovered, setIsHovered] = useState(false);
  const src = `/Projetos/${foto}`;
    ...
    <div className="p-6 rounded-xl shadow-lg flex flex-col">
      ...
      >
        <Image
          ...
          width={400}
          height={400}
          className="object-cover w-full max-h-[400px] aspect-square bg-black border-2 rounded-3xl transition-transform duration-300 ease-in-out"
